...
my $won_by_player_1 = 0;
for my $line (@pasted_lines) {
    my @cards          = split / /, $line;
    my @player_1_cards = @cards[ 0 .. 4 ];
    my @player_2_cards = @cards[ 5 .. 9 ];
    $won_by_player_1++
      if ScoreHand(@player_1_cards) < ScoreHand(@player_2_cards);
}
print "$won_by_player_1\n";
